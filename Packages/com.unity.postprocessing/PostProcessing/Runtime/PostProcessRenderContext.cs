...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class PostProcessRenderContext
    {
        ...
        /// <summary>
        /// A reference to the Upscaler settings for the rendering layer.
        /// </summary>
        ...
        /// <param name="upscaleRandomWrite">Whether to enable random read/write on the texture when isUpscaleOutput is true</param>
        public void GetScreenSpaceTemporaryRT(CommandBuffer cmd, int nameID,
            ...
            FilterMode filter = FilterMode.Bilinear, int widthOverride = 0, int heightOverride = 0, bool isUpscaleOutput = false, bool upscaleRandomWrite = false)
        {
            ...
            if (isUpscaleOutput)
            {
                desc.enableRandomWrite = upscaleRandomWrite;
